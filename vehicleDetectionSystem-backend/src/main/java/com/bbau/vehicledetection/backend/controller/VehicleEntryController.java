...
public class VehicleEntryController {
    ...
    @PostMapping("/entry")
public ResponseEntity<?> registerVehicleEntry(@RequestBody VehicleEntry vehicleEntry) {
    try {
        vehicleEntryService.handleVehicleEntry(vehicleEntry); // Pass the entire object
